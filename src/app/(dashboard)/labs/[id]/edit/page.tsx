  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(error.error?.message || 'Failed to update lab');
      }
    } catch (error) {
  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div className="text-center py-8">Loading lab...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Edit Laboratory</h1>
          <p className="text-muted-foreground">Update laboratory information</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the laboratory details</CardDescription>
          </CardHeader>
